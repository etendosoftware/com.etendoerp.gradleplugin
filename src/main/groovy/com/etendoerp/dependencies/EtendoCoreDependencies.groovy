...
class EtendoCoreDependencies {
    ...
    static void loadCoreCompilationDependencies(Project project) {
        ...
        project.dependencies {
            ...
            implementation('com.fasterxml.jackson.core:jackson-core:2.12.1') { transitive = false }
            ...
            implementation('com.fasterxml.jackson.core:jackson-databind:2.12.1') { transitive = false }
            ...
            implementation('org.redisson:redisson:3.20.1') { transitive = false }
            ...
            implementation('com.fasterxml.jackson.core:jackson-annotations:2.12.1') { transitive = false }
