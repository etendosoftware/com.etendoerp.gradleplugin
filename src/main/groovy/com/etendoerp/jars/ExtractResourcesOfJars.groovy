...
class ExtractResourcesOfJars {
    ...
    static void extractResources(Project project) {
        ...
        etendoJarFiles.each {
            ...
            // The jar is the CORE
            // The copy task should be used to prevent deleting autogenerated files ('src-gen','srcAD')
            ...
            if (name != JarCoreGenerator.ETENDO_CORE) {
                ...
                project.sync {
                    ...
                    into "${etendoModulesLocation}${name}"
                    eachFile { f ->
                        f.path = f.path.replaceFirst("${JAR_ETENDO_MODULE_LOCATION}${name}", '')
                    }
                    includeEmptyDirs false
                }
                ...
                project.sync {
                    ...
                    into "${etendoModulesLocation}${name}/src"
                    includeEmptyDirs false
                }
            }
        }
